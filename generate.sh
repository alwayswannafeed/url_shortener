...
GENERATED="${GOPATH}/src/github.com/alwayswannafeed/url_shortener/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/alwayswannafeed/url_shortener/docs/web_deploy"
